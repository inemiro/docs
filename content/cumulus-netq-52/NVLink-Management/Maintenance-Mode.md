...
Maintenance mode is a low-noise state you enable while performing disruptive operations such as certificate rotation. While it is on, NetQ NVLink suppresses fault-tolerance recovery and some other internal processes, so the work does not trigger alerts or automatic recovery actions.
